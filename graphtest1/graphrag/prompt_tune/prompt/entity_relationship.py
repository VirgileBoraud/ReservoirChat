...
3. You need to make particuliar intention to the similar entity_name and if needed merge their description. For example The Doctor Castafolte and Henry Castafolte or Doug and Doug Rattmann are the same person so you need to fuze their description

4. Return output in {language} as a single list of all the entities and relationships identified in steps 1 and 2. Use **{{record_delimiter}}** as the list delimiter. If you have to translate, just translate the descriptions, nothing else!
